...
const companies = [
    ...
    },
    {
        ...
        svg: (
            <svg viewBox="0 0 24 24" className="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.5 17.5C2.6 17.5 1 15.2 1 12s1.6-5.5 3.5-5.5c2.2 0 4.2 3.2 7.5 8 3.3-4.8 5.3-8 7.5-8 1.9 0 3.5 2.3 3.5 5.5s-1.6 5.5-3.5 5.5c-2.2 0-4.2-3.2-7.5-8-3.3 4.8-5.3 8-7.5 8Zm0-8c-.5 0-1 .9-1 2.5s.5 2.5 1 2.5 1.8-1.6 3.4-4C6.3 11.1 5 9.5 4.5 9.5Zm15 0c-.5 0-1.8 1.6-3.4 4 1.6 2.4 2.9 4 3.4 4 .5 0 1-.9 1-2.5s-.5-2.5-1-2.5Z" fill="#0866FF"/>
            </svg>
        ),
    },
    {
